...
let allowedOrigins = ['http://localhost:8080','http://localhost:1234', 'https://movieapicf-30767e813dee.herokuapp.com', 'https://myflix-alinatelychko.netlify.app', 'http://localhost:4200'];
app.use(cors({
